...
function Registration(props) {
	...
	return (
		<div
			style={{
				background:
					'linear-gradient(341.24deg, #B5E4FE 11.16%, #BDF5FF 82.03%)',
				height: '100vh'
			}}
		>
			<form className={classes.container} onSubmit={e => submitHandler(e)}>
				...
				>
					...
					<div
						style={{ width: '100%', paddingTop: '25px', paddingBottom: '25px' }}
					>
						<TextField
							label='Email'
							type='email'
					...
					<div>
						<p>
							...
							<Link style={{ padding: '0', color: 'black' }} to='/Login/'>
								Sign in here
							</Link>
						</p>
					</div>
...
export default connect(mapStateToProps, { shouldUpdateLoggedInUser })(
	Registration
);
